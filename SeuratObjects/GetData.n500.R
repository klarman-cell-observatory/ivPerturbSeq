...
load("dat.Robj")
#lst=(list of fdirectories)

#load data

seur<-dir10X(dat=dat)

##add locations of files
#seur@meta.data["File"]=lst[as.numeric(as.character(seur@meta.data$orig.ident))]
...
#TSNE and clustering
seur<-RunTSNE(seur,dims.use=1:28,verbose=T)

seur<-FindClusters(seur,dims.use=1:28,resolution=1.2)
...
scrub<-scan(paste(savedir,"/scrublet.txt",sep=""))
...
mapToCellType[c(1,8,9,10,16)]="Excitatory"
mapToCellType[c(15,30,12,22,24)]="Inhibitory"
#mapToCellType[c(24)]="Inhibitory"

mapToCellType[c(34)]="IPC"
mapToCellType[c(3,23,31)]="ODC"

mapToCellType[c(4,5,7,11,13,26)]="Astroglia"
mapToCellType[c(17,20)]="Fibroblast-like"
mapToCellType[c(33)]="Ependyma"
mapToCellType[c(25)]="Hippocampus"
mapToCellType[c(32)]="Chodoir Plexus"
mapToCellType[c(6,18,29,36)]="Vascular"
mapToCellType[c(37,38,39)]="Doublet"
mapToCellType[c(28,2,14,27,19,21,35)]="Microglia"
